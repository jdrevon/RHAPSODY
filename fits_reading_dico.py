...
import shutil
from rhapsody_init import PROCESS_DIR, ntelescope, OIFITS_FLUX, DATA_band_name, REFLAGGING_DATA
...
#             except:
#                 FLUX_FILE = False
#                 print('WARNING: No flux available please check this file: %s'%filenames)
